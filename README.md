...
<p><b>What classes you got from other sources:</b> Introduction to AUDIO in Unity by Brackeys. The class was located on a different script which defined the volume of the sound effect, the spatial sound, the pitch, the sound effect and the name of the sound effect. This video is referenced in the section below. </p>
<p><b>What classes you got from other sources:</b> OBJECT POOLING in Unity by Brackeys. The class was located on the object pooling script which defined the name of the object pool, its size and the prefab for the object pool. This video is referenced in the section below. </p>

<h2>What scripts you got from the course or from other sources. Include references:</h2> 
<p>
<ol>
