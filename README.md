...
<p>The last part of the assignment that I like is the Bezier curve, which I got working. This added a whole different way that the cut scene could be viewed or certain assets. At one point in the cut scene, I had linked several Bezier curves together, and I was able to get the camera the follow these curves while looking at the curve. This made the camera look like it was following a track as it moved through the cut scene moving in and out of the Empires Fleet during the Battle. This in my opinion better portrayed the cut scene instead of static camera in the scene. </p>
